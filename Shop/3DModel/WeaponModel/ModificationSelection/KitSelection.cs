...
public class KitSelection : MonoBehaviour
{
    [SerializeField] private List<KitItem> _awailableBarrels = new List<KitItem>();
    ...
    {
        ModsDataHelper.Instance.KitMod = modification;
    }
}
